"""Командная строка для Ре-Файл+.

Обеспечивает переименование файлов через командную строку
с поддержкой различных методов переименования.
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Ре-Файл+ - утилита для переименования файлов',
